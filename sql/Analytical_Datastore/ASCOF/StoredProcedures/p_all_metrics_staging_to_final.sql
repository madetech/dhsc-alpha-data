...
BEGIN
    ...
    SELECT
        ...
        CAST([Geographical Code] AS NVARCHAR) AS [geographical_code],
        CAST([Geographical Description] AS NVARCHAR) AS [geographical_description],
        CAST([Geographical Level] AS NVARCHAR) AS [geographical_level],
        CAST([ONS Code] AS NVARCHAR) AS [ons_code],
        CAST([ASCOF Measure Code] AS NVARCHAR) AS [ascof_measure_code],
        CAST([Disaggregation Level] AS NVARCHAR) AS [disaggregation_level],
        CAST([Measure Group] AS NVARCHAR) AS [measure_group],
        CAST([Measure Group Description] AS NVARCHAR) AS [measure_group_description],
